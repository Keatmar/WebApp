		...
		<div class="row centered-form">
			<div class="col-md-12  col-sm-12  column">
				<div class="panel panel-default">
					...
					<form role="form" action="./CreateAuction"
								...
								<div class="col-md-3 col-sm-3">
									<div class="form-group text-center">
										<label>Buy Price</label> <input type="text" name="Buy_Price"
											class="form-control input-sm" placeholder="Buy Price">
									</div>
								...
								<div class="col-md-3 col-sm-3">
									<div class="form-group text-center">
										<label>First Bid</label> <input type="text" name="First_Bid"
											class="form-control input-sm" placeholder="First Bid">
									</div>
							        ...
							        <div class='col-sm-5 col-sm-offset-3'>
							            <div class="form-group">
							                <div class='input-group date' id='datetimepicker1'>
							                    <input type='text' class="form-control" name="datetime_field" />
